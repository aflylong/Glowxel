...
struct TerrariaSprite {
  ...
  uint8_t fmt;  // 5 = x8,y8,r,g,b; 7 = x16,y16,r,g,b; 8/9 = boss palette packed set pixels
};
...
struct TerrariaFrameBlock {
  ...
  const uint8_t* setPixels;     // fmt=5: [x,y,r,g,b]; fmt=7: [x_lo,x_hi,y_lo,y_hi,r,g,b]; boss fmt=8/9: [pos,paletteIndex]
