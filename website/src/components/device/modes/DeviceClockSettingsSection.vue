<template>
  <section class="mode-clock-section">
    ...
    <div v-if="showSecondsControl" class="mode-clock-row">
      <span class="mode-clock-row__label">鏄剧ず绉掗挓</span>
    ...
    <div v-if="showFontSize" class="mode-clock-row">
      <span class="mode-clock-row__label">瀛椾綋澶у皬</span>
    ...
    <div class="mode-clock-row">
      <span class="mode-clock-row__label">X 浣嶇疆</span>
      <div class="mode-clock-stepper">
        <button
          type="button"
          class="mode-clock-stepper__button"
    ...
    <div class="mode-clock-row">
      <span class="mode-clock-row__label">Y 浣嶇疆</span>
      <div class="mode-clock-stepper">
        <button
          type="button"
          class="mode-clock-stepper__button"
    ...
    <div class="mode-clock-block">
      <span class="mode-clock-row__label">瀵归綈鏂瑰紡</span>
    ...
    <div class="mode-clock-block">
      <div class="mode-clock-block__head">
        <span class="mode-clock-row__label">棰滆壊</span>
        <input
