  ...
  <div class="control-page glx-page-shell">
    ...
    >
      <div class="console-card glx-panel-card">
        <div class="console-card-header">
          <div class="device-summary">
            <div class="device-logo">
              <div class="device-logo-core"></div>
            </div>
            <div class="device-summary-text">
              <span class="device-name">Glowxel PixelBoard</span>
        ...
        <div v-if="!isDeviceConnected" class="connect-entry-grid">
          <div class="connect-entry-card" @click="handleConnect">
            <div class="connect-entry-icon">
          ...
          <div class="connect-entry-card" @click="goToWifiConfig">
            <div class="connect-entry-icon mint">
      ...
      <div class="section-block">
        ...
        <div class="mode-badge-grid">
          ...
          >
            ...
            <span class="mode-badge-name">{{ entry.name }}</span>
          </div>
        </div>
      </div>
...
import ConnectModal from "@/components/uni/ConnectModal.vue";
