<!-- AUTO-CONVERTED FROM uniapp/pages/clock-editor/clock-editor.vue -->
<template>
        ...
        <div v-show="currentTab === 3" class="settings-card">
          ...
          <div class="image-upload">
            ...
            >
              ...
              <span class="upload-text">鐐瑰嚮涓婁紶鑳屾櫙鍥剧墖</span>
              <span class="upload-hint">鏀寔闈欐€佸浘鐗囷紝寤鸿 64x64 浠ュ唴</span>
            </div>
          ...
          <div v-if="config.image.data" class="setting-group">
            ...
            <div class="setting-item-row">
              ...
              <div class="setting-control-buttons">
                ...
                <span
                  ...
                  >{{ config.image.width }}</span>
                <div class="control-btn" @click="adjustImageValue('width', 1)">
                  <span class="control-icon">+</span>
                </div>
              </div>
            </div>
            ...
            <div class="setting-item-row">
              ...
              <div class="setting-control-buttons">
                ...
                <span class="setting-value-large">{{ config.image.x }}</span>
                <div class="control-btn" @click="adjustImageValue('x', 1)">
                  <span class="control-icon">+</span>
                </div>
              </div>
            ...
            <div class="setting-item-row">
              ...
              <div class="setting-control-buttons">
                ...
                <span class="setting-value-large">{{ config.image.y }}</span>
                <div class="control-btn" @click="adjustImageValue('y', 1)">
                  <span class="control-icon">+</span>
                </div>
              </div>
...
import imageGifMixin from "@/mixins/clock-editor/imageGifMixin.js";
...
export default {
  ...
  data() {
    return {
      ...
      toast: null,
      isReady: false,
      clockMode: "clock", // clock=闈欐€佹椂閽? animation=鍔ㄦ€佹椂閽? theme=涓婚妯″紡
